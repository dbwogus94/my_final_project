...
-- 추가
INSERT INTO BOARD VALUES(BOARD_SEQ.NEXTVAL, 0, 1, NULL, 'test@naver.com', '제목 : 테스트', '글내용..', NULL, SYSDATE);
...
BEGIN
	LOOP
		EXIT WHEN V_CNT = 100;
			INSERT INTO BOARD VALUES(BOARD_SEQ.NEXTVAL, 0, 1, NULL, 'test@naver.com', '제목 : 테스트'||TO_CHAR(V_CNT), '글내용..', NULL, SYSDATE);
			V_CNT := V_CNT +1;
	END LOOP;
END;
